...
import com.chuanggu.app.dao.OrganizationDao;
...
public class OrganizationDaoImpl implements OrganizationDao {
    ...
    public Organization findOne(Long organizationId) {
        final String sql = "select id, name, parent_id, parent_ids, available from sys_organization where id=? order by name";

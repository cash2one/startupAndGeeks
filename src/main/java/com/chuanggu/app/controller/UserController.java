...
//        model.addAttribute("permission", "user:create");
//        return "user/edit";
//    }
//
...
//        model.addAttribute("permission", "user:update");
...
//        model.addAttribute("permission", "user:delete");
//        return "user/edit";
//    }
//
...
//        int count = userService.deleteBatchRecord(idList);

...
import cn.kawa.studio.cache.redis.pooled.JedisLuaScriptExecutor;
...
public class AdvancedJobConsumer {
	...
	private JedisLuaScriptExecutor singlePopScriptExecutor;
	private JedisLuaScriptExecutor batchPopScriptExecutor;
	...
	public AdvancedJobConsumer(String jobName, JedisPool jedisPool) {
		...
		singlePopScriptExecutor = new JedisLuaScriptExecutor(jedisPool);
		batchPopScriptExecutor = new JedisLuaScriptExecutor(jedisPool);
	}

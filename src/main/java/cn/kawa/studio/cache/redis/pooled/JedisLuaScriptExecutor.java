package cn.kawa.studio.cache.redis.pooled;
 ...
 */
public class JedisLuaScriptExecutor {
	private static Logger logger = LoggerFactory.getLogger(JedisLuaScriptExecutor.class);
	...
	public JedisLuaScriptExecutor(JedisPool jedisPool) {
		this.jedisTemplate = new JedisTemplate(jedisPool);
	}

	public JedisLuaScriptExecutor(JedisTemplate jedisTemplate) {

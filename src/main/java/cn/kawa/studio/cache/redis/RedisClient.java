...
public class RedisClient implements RedisToServer{
    ...
    { 
        ...
        System.out.println("======================shardedJedisPool.getResource()=========================="); 
...
//        config.setMaxWait(1000l); 
        ...
        jedisPool = new JedisPool(config,"192.168.13.129",6379,100000);
...
//        config.setMaxWait(1000l); 
        ...
        shards.add(new JedisShardInfo("192.168.13.129", 6379, "master")); 

        // 构造池 
        shardedJedisPool = new ShardedJedisPool(config, shards); 
        System.out.println("======================initialShardedPool==========================");
    } 
